...
::: {.alert .alert-primary}
Open the application called RStudio, not R

![r or rstudio](assets/images/r-start-r-or-rstudio.png){fig-align="left"}
::: 
...
The upper right screen is the Environment, which is where your active *variables* live. A variable is a named thing. It might be a word, a list of words or numbers, or a data frame (spreadsheet). You will understand this better after you take the Posit "Programming basics" [tutorial referenced below](#tutorials).
...
The console remembers your commands, but you have to type them one at a time and it will forget them when you leave for the day. That's why we're going to work in programs called Quarto documents most of the time.^[These used to be "R Markdown". Quarto is the newer implementaiton of it, but you'll often see R Markdown referenced in other places.]

## Take a tutorial {#tutorials}

::: {.alert .alert-primary}
Take the ["Programming basics" tutorial](https://posit.cloud/learn/primers/1.2) from Posit.
:::
...
## Install a few more packages {#packages}
...
::: {.content-visible when-format="html"}
![](https://cronkitedata.s3.amazonaws.com/images/r-start-newproject.gif)
:::

::: {.content-visible when-format="pdf"}
![](assets/images/r-start-newproject.png)
:::
