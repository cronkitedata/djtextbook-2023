...
::: callout-note
### Follow a tutorial instead
If it's easier, you can follow this interactive tutorial on installing R, RStudio and the tidyverse on your computer:
...
You can skip the part about installing the tidyverse--- we'll do that in the next chapter.
