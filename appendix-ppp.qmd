...
- *Reveal* worked with https://geocod.io to add latitude and longitude to each loan, allowing them to match it to Census data. We will look at that data in the mapping / geography portion of the course 